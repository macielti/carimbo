(ns carimbo.db.datahike.transaction
  (:require [carimbo.adapters.transaction :as adapters.transaction]
    ...
    #_[datahike.http.client :as client]))

#_(s/defn insert! :- models.transaction/Transaction
...
#_(s/defn by-customer :- [models.transaction/Transaction]
    [customer-id :- s/Int
     database]
...
#_(defn update-customer-balance [db incoming-transaction]
...
#_(s/defn insert-with-account-balance-upsert! :- models.transaction/Transaction
    [transaction :- models.transaction/Transaction
     db-connection]
    (try
